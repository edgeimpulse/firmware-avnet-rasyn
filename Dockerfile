...
ENV ENV_FSP_PACK_VERSION=v4.5.0
...
CMD chmod +x ${ENV_E2STUDIO_DEFAULT_WS}/firmware-avnet-rasyn/build.sh && ${ENV_E2STUDIO_DEFAULT_WS}/firmware-avnet-rasyn/build.sh
