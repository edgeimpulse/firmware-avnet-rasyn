...
#define VECTOR_NUMBER_ICU_IRQ5 ((IRQn_Type) 17) /* ICU IRQ5 (External pin interrupt 5) */
#define ICU_IRQ5_IRQn          ((IRQn_Type) 17) /* ICU IRQ5 (External pin interrupt 5) */
...
#define VECTOR_NUMBER_DMAC0_INT ((IRQn_Type) 22) /* DMAC0 INT (DMAC transfer end 0) */
#define DMAC0_INT_IRQn          ((IRQn_Type) 22) /* DMAC0 INT (DMAC transfer end 0) */
#define VECTOR_NUMBER_DMAC1_INT ((IRQn_Type) 23) /* DMAC1 INT (DMAC transfer end 1) */
#define DMAC1_INT_IRQn          ((IRQn_Type) 23) /* DMAC1 INT (DMAC transfer end 1) */
#ifdef __cplusplus
        }
        #endif
#endif /* VECTOR_DATA_H */
